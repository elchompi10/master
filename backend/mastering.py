...
class MasteringParams:
    ...
    # ── shelf = tonal/sweetening (stage 6). Ver apply_mastering_chain.      ──
    eq_mode: str = "iir"
...
def process_audio(
    ...
    if use_lufs_normalize:
        ...
        for i in range(max_iters):
            ...
            # viene del dict cacheado (_chain_kwargs, con nr_bypass ya forzado
            # a True) — no hay lista manual de kwargs que desincronizarse con
            # la firma real de apply_mastering_chain, y se reusa audio_base
            # (ya limpio de ruido) en vez de recalcularlo en cada intento.
            retry_kwargs = dict(_chain_kwargs)
