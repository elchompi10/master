...
def chat(user_message: str, history: Optional[list] = None,
    ...
    raw = _gemini_generate_content(system_prompt, contents, max_output_tokens=2048)
...
BOOL_PARAM_FIELDS = [
    ...
    "dyneq_bypass", "ms_eq_bypass", "reso_bypass", "clipper_bypass", "nr_bypass",
]
...
def decide_mastering(analysis: Optional[dict], platform_options: list,
    ...
    try:
        ...
        raw = _gemini_generate_content(
            system_prompt, contents, max_output_tokens=4096,
